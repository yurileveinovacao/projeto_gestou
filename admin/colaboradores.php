...
if (empty($_SESSION["colaborador_filtro_tipo"])) {
    ...
    $tipo_filtro = $_SESSION["colaborador_filtro_tipo"];
}
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="dataTable" class="table table-bordered sortable" width="100%" cellspacing="0">
                                    ...
                                    <tbody class="texto-table-body funcionarios">
                                        ...
                                        foreach (select_TABELA_COLABORADORES0($raiz_cnpj, $id_emp_default, $id_usa_default, $situac, $tipo_filtro) as $linha) {
                                            if (!empty($linha)) {
                                                        ...
                                                        <tr style="background-color: #F5F5F5;">
                                                            ...
                                                            <td class="content-xy-center">
                                                                ...
                                                                <?php if (!empty($linha["cpf"])) { ?>
                                                                    ...
                                                                    <div class="div-acoes">
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <span class="text-danger cursor-pointer btn_situac" colaborador="<?php echo $linha["id_usu"]; ?>"><i class='bx bxs-toggle-left bx-lg content-xy-center' title="Inativo"></i></span>
                                                                        ...
                                                                        ?>
                                                                            ...
                                                                            <span class="text-success cursor-pointer btn_situac" colaborador="<?php echo $linha["id_usu"]; ?>"><i class='bx bxs-toggle-right bx-lg content-xy-center' title="Ativo"></i></span>
                                                                ...
                                                                <div class="div-acoes">
                                                                    ...
                                                                    } else if ($linha["verificacao_usa_rh"] == 'N') { ?>

                                                                        <button type="button" class="btn btn-secondary btn-icones" disabled>
                                                                            <i class="fas fa-camera-retro"></i>
                                                                        </button>
                                                            ...
                                                            <td class="content-xy-center">
                                                                ...
                                                                <div class="div-acoes">
                                                                    ...
                                                                    <?php if ($linha["situac"] == 0) { ?>
                                                                        ...
                                                                        <span class="text-danger cursor-pointer btn_situac" colaborador="<?php echo $linha["id_usu"]; ?>">
                                                                            <i class='bx bxs-toggle-left bx-lg content-xy-center' title="Inativo"></i>
                                                                        </span>
                                                                    <?php } else { ?>

                                                                        <span class="text-success cursor-pointer btn_situac" colaborador="<?php echo $linha["id_usu"]; ?>">
                                                                            <i class='bx bxs-toggle-right bx-lg content-xy-center' title="Ativo"></i>
                                                                        </span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mt-1">
                                    ...
                                    <?php switch ($tipo_filtro) {

                                        case "M": ?>

                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo1" name="tipo" value="M" data-cad="tipo-matriz" class="btn1 custom-control-input filtro-tipo" checked>
                                                <label class="custom-control-label" for="tipo1">Matriz</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo2" name="tipo" value="F" data-cad="tipo-filial" class="btn1 custom-control-input filtro-tipo">
                                                <label class="custom-control-label" for="tipo2">Filial</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo3" name="tipo" value="T" data-cad="tipo-todos" class="btn1 custom-control-input filtro-tipo">
                                        ...
                                        case "F": ?>
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo1" name="tipo" value="M" data-cad="tipo-matriz" class="btn1 custom-control-input filtro-tipo">
                                                <label class="custom-control-label" for="tipo1">Matriz</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo2" name="tipo" value="F" data-cad="tipo-filial" class="btn1 custom-control-input filtro-tipo" checked>
                                                <label class="custom-control-label" for="tipo2">Filial</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo3" name="tipo" value="T" data-cad="tipo-todos" class="btn1 custom-control-input filtro-tipo">
                                        ...
                                        default: ?>
                                            ...
                                            ?>
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="tipo1" name="tipo" value="M" data-cad="tipo-matriz" class="btn1 custom-control-input" disabled>
                                                    <label class="custom-control-label" for="tipo1">Matriz</label>
                                                </div>

                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="tipo2" name="tipo" value="F" data-cad="tipo-filial" class="btn1 custom-control-input" disabled>
                                                    <label class="custom-control-label" for="tipo2">Filial</label>
                                                </div>
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="tipo3" name="tipo" value="T" data-cad="tipo-todos" class="btn1 custom-control-input filtro-tipo" checked>
                                                <label class="custom-control-label" for="tipo3">Todos</label>
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '#btn-incluir', function() {
            ...
            if (btn_incluir !== '') {
                ...
                location.href = "cadastrar_colaborador";
                    ...
                    switch (retorna) {
                        ...
                        case '0':
                            Swal.fire({
                                icon: 'info',
                                title: 'Atenção!',
                                text: 'Não é possivel ativar colaborador sem CPF',
                        ...
                        case '1':
                            Swal.fire({
                                icon: 'info',
                                title: 'Atenção!',
                                text: 'Já existe um colaborador ativo com esse CPF',
                                allowOutsideClick: false,
                                allowEscapeKey: false
                            }).then((result) => {
                                if (result.isConfirmed) {
                        ...
                        case '2':
                            Swal.fire({
                                icon: 'info',
                                title: 'Atenção!',
                                text: 'Colaborador bloqueado, por favor revise o cadastro para continuar.',
                                allowOutsideClick: false,
                                allowEscapeKey: false
                            }).then((result) => {
                                if (result.isConfirmed) {
                            ...
                            switch (retorna) {
                                ...
                                case '0':
                                    Swal.fire({
                                        ...
                                        title: 'Error',
                                        title: 'Erro!',
                                        text: 'O registro não pode ser excluido, pois possui referencia em outra tabela.',
                                        closeOnClickOutside: false,
                                        allowOutsideClick: false
                                    }).then((result) => {
                                        if (result.isConfirmed) {
        ...
        $(document).on('click', '.btn-beneficios', function() {
            ...
            if ((btn_beneficios !== '') && (colaborador_beneficios !== '')) {
                ...
                $.post('controller/colaboradores_post.php', dados, function(retorna) {
                    ...
                    location.href = "documentos_colaborador";
    ...
    $(document).ready(function() {
        $(document).on('click', '#btn-filtrar', function() {
            ...
            var colaborador_filtro_tipo = $('.filtro-tipo:not(:disabled):checked').val();

            if ((btn_filtrar !== '') && (colaborador_filtro_situac !== '') && (colaborador_filtro_tipo !== '')) {
                var dados = {
                    btn_filtrar: btn_filtrar,
                    colaborador_filtro_situac: colaborador_filtro_situac,
                    colaborador_filtro_tipo: colaborador_filtro_tipo
                };
                $.post('controller/colaboradores_post.php', dados, function(retorna) {
