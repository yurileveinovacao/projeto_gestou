                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Benefícios aprovados</h6>
                        </div>
                        <div class="card-body">
...
<?php foreach (selectRECIBO_PAGAMENTO($raiz_cnpj, 3) as $linha) { ?> <!-- Passar o parâmetro 3 para filtrar o status APROVADO do GESIM1_raiz -->
                                        <tr>
