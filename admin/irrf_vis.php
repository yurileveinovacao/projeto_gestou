...
<head>
    ...
    <title>GESTOU PORTAL - Recibo de Pagamentos</title>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="row mt-sm-2">
                                            ...
                                            <input id="input-b1" name="input-b1" type="file" class="file" layout="<?php echo $layout_holerite; ?>" data-browse-on-zone-click="true" accept=".pdf,.txt" required>
