							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">Código de Validação!</h1>
									</div>
									<form class="user" action="esqueci_valida_codigo.php" method="POST">
										<div class="form-group">
											<input type="text" name="codigo" class="form-control form-control-user" id="codigo" placeholder="Digite o código enviado por e-mail">
										</div>
										<div class="form-group">
											<button type="submit" name="consulta-codigo" class="btn btn-brave btn-user btn-block">
												<h6 class="mb-0"><span class="fonte-texto-gestou">AVANÇAR</span></h6>
											</button>
										</div>
										<div class="form-group">
											<a href="esqueci_senha" style="text-decoration: none;"><button type="button" class="btn btn-voltar btn-user btn-block">
