...
if ($pos != false) {
    ...
    $vR28_0 = substr($var, $vR28, 1800);
    $vR28_1 = strpos($vR28_0, 'Pág.'); //Final
    $vgrupo6 = rtrim(ltrim(substr($vR28_0, 0, $vR28_1)));

    // echo '<br>Inicio Grupo 6======'.$vR28;
    // echo '<br>FIM Grupo 6======'.$vR28_1;
    // echo '<br>$vgrupo6===='.$vgrupo6;
    // echo '<br>$vR28===='.$vR28;
    // echo '<br>$vR28_1===='.$vR28_1;

    //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

    $vR28_2 = strpos($vgrupo6, ':'); //Inicio
    $vR28_3 = substr($vgrupo6, $vR28_2, 120);
    $vR28_4 = strpos($vgrupo6, 'Quantidade'); //Final
    $vnprocesso = rtrim(ltrim(substr($vgrupo6, $vR28_2 + 1, $vR28_4 - 9)));

    // echo '<br>$vR28_3========'.$vR28_3;
    // echo '<br>$vnprocesso===='.$vnprocesso;
    ...
    if (!empty($linha_u['id_usu'])) {
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------------------------------';
        $n6_1_nprocesso = "'".rtrim(ltrim($vnprocesso))."'";
    ...
    // echo '<br>ENTROU ELSEIF';
    if (strlen($hor_seg) != 0 && strlen($id_irr) != 0) {
        // echo '<br>id_irr='.$id_irr;
        // echo '<br>Pagina='.substr($var, -3, -1);
        // echo '<br>---------------------------------------------------------------------------------------------------------------------------------------------------------------';
        // echo '<br>var===='.$var;

        // echo '<br> strlen $hor_seg==='.strlen($hor_seg);
        // echo '<br> $$busca_cnpj==='.$busca_cnpj;
        // echo '<br> $hor_seg==='.$hor_seg;
