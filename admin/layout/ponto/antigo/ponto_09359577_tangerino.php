...
$erro_6 = '../../erro/erro_6'; //erro arquivo anexado
...
//------------------------------------------------PONTO Secullum
$texto0 = $text;
$pattern0 = '/(Secullum Ponto)/'; //expressao regular cnpj
preg_match($pattern0, $texto0, $matches0);
if (!empty($matches0)) {

    die((header('Location:' . $erro_6)));
}
...
$busca_cnpj = substr($raiz_cnpj,0,2).'.'.substr($raiz_cnpj,2,3).'.'.substr($raiz_cnpj,5,3);

$pos = strpos($text, $busca_cnpj);
$v24 = $pos + 19; //INICIO
$v24_1 = substr($text, $v24 + 2, 12);
$v24_4 = rtrim(ltrim($v24_1));
$v244 = strpos($text, 'Folha');
$v24_2 = substr($text, $v244 - 12, 12); //FINAL
$v24_3 = rtrim(ltrim($v24_2));
$periodo = $v24_4 . ' ATÉ ' . $v24_3;
