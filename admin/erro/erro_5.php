            ...
            <div class="error-502">
                <div class="error-502__text">
                    <div class="row justify-content-center">
                        <h2>Erro na importação<b>:(</b></h2>
                    </div>
                    <div class="row justify-content-center">
                        <p style="font-size: 1.25rem;">Favor verificar arquivo.</p>
                    </div>
                    <div class="row justify-content-center" style="padding: 0 20em;">
                        <div class="col-md-1">
                        </div>
                        <div class="col-md-10">
                            <textarea id="erro" style="user-select: none; width: 100%; resize: none; text-align: center; outline: 0;border:none;color: #7f8084;line-height: 1.429;margin-top: 0;font-weight: 300;font-size: 1.5rem;" readonly><?php echo $_SESSION['erro cnpj']; ?></textarea>
                        </div>
