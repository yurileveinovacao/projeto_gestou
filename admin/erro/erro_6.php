        ...
        <div class="error-502__container">
            <div class="error-502">
                <div class="error-502__text">
                    ...
                    <h2>
                        <p style="font-size: 1.25rem;">O arquivo anexado não pertence a esse layout.</p> <a href="../ponto.php"><button class="btn btn-brave" style="margin-bottom: 50px;">VOLTAR</button></a>
                    </h2>
                </div>
            </div>
        </div>
