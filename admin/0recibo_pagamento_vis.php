                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="descricao" name="descricao" layout="holerite/dominio_v9_mr" placeholder="Insira uma descrição..." required></input>
                                ...
                                <div class="form-group">
                                    <div class="textalign-right">
                                        <button type="button" id="btn-submit" name="btn-submit" class="btn btn-organograma btn-icon-split-organograma">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#btn-submit").click(function() {
            ...
            var layout = $('#descricao').attr("layout");
