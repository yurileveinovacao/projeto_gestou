                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Benefícios reprovados</h6>
                        </div>
                        <div class="card-body">
...
<button type="submit" name="btn-voltar" data-toggle="tooltip" title="Voltar para aceite de benefícios" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-undo-alt"></i> Voltar</button>
                                        ...
                                        <tr>
                                            <th data-orderable="false"
                                                class="sorttable_nosort nao_click coluna-checkbox"><input id="checkTodos" type="checkbox" name="checkbox[]"></input></th>
...
<?php foreach (selectRECIBO_PAGAMENTO($raiz_cnpj, 4) as $linha) { // Passar o parâmetro 1 para filtrar o status do GESIM1_raiz
                    if ($linha == 0) {
                    } else {
                        ?> 
                                        <tr>
...
<!-- FIM DO WHILE COM RETORNO DO BANCO -->
            ...
            <!-- Eventos Modal-->
            <div class="modal fade" id="Eventos" style="padding-right: none !important;" tabindex="-1" role="dialog"
                aria-labelledby="Eventos" aria-hidden="true">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-orderable="false" width="10%"
                                                        class="sorttable_nosort nao_click">Evento</th>
                                                    <th data-orderable="false"
                                                        class="coluna-nome sorttable_nosort nao_click">Descrição</th>
                                                    <th width="10%" data-orderable="false" style="text-align: center"
                                                        class="sorttable_nosort nao_click">Status</th>
                                                    <th width="25%" data-orderable="false"
                                                        class="sorttable_nosort nao_click">Tipo</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
    ...
    while ($row_eventos = pg_fetch_assoc($res_eventos)) {
        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="m-0 tamanho-text linha-altura"><?php echo $row_eventos['codevento']; ?></span>
                                                    </td>
                                                    <td><span
                                                            class="m-0 tamanho-text linha-altura"><?php echo $row_eventos['nome']; ?></span>
                                                    </td>
                                                    <td style="text-align: center" class="linha-altura">
                                                        <?php
                                                    if ($row_eventos['tipo'] == 'P') {
                                                        ?>
                                                        <img src="img/pendente.png" title="Pendente" height="35"
                                                            width="35"></img>
                                                        <?php
                                                    }
        if ($row_eventos['tipo'] == 'D') {
            ?>
                                                        <img src="img/desconto.png" title="Desconto" height="35"
                                                            width="35"></img>
                                                        <?php
        }
        if ($row_eventos['tipo'] == 'V') {
            ?>
                                                        ...
                                                        <img src="img/vencimento.png" title="Vencimento" height="35"
                                                            width="35"></img>
            ...
            while ($linha_eventos1 = pg_fetch_assoc($result_tipo1)) {
                ...
                if ($linha_eventos1['tipo'] == 'D') {
                    ?>
                                                            ...
                                                            <option value="<?php echo $linha_eventos1['tipo']; ?>"
                                                                style="color: red">
                                                                <?php echo $linha_eventos1['tipo_f']; ?></option>
                                                            <option value="V" style="color: blue">VENCIMENTO</option>
