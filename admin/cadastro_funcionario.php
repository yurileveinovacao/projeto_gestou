                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <!-- INÍCIO FORM -->
                            <form class="needs-validation" novalidate action="cadastro_funcionario" method="POST">
                                        ...
                                        <div class="tab-pane fade" id="menu-informacoes" role="tabpanel" aria-labelledby="menu-informacoes-tab">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="salario" placeholder="R$" name="salario" maxlength="12" onKeyPress="return(moeda(this,'.',',',event))">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="dependentes">Dependentes</label>
                                                    <input type="text" maxlength="2" value="0" class="form-control" id="dependentes" name="dependentes">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
