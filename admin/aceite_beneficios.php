                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Aceite benefícios</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table id="dataTable" class="table table-bordered sortable" width="100%" cellspacing="0">
                                        <thead>
                                            <div class="col-sm-12 button-tabela">
                                                ...
                                                <button type="submit" name="btn-processar" data-toggle="tooltip" title="Processar benefícios" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-cog"></i> Processar</button>
                                                <button type="submit" id="btn-recusar" name="btn-recusar" data-toggle="tooltip" title="Excluir benefícios" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-ban"></i> Excluir</button>
                                                ...
                                                <button type="submit" id="btn-enviados" name="btn-enviados" data-toggle="tooltip" title="Benefícios enviados" class="btn btn-primary btn-icon-split-organograma"><i class="fas fa-eye"></i> Enviados</button>
                                                <!-- <button type="submit"  id="btn-recusados" name="btn-recusados" data-toggle="tooltip" title="Benefícios reprovado" class="btn btn-primary btn-icon-split-organograma"><i class="fas fa-eye"></i> Reprovados</button>  -->
                                        ...
                                        <tbody class="texto-table-body">
                                            <?php foreach (selectRECIBO_PAGAMENTO($raiz_cnpj, 1) as $linha) { // Passar o parâmetro 1 para filtrar o status do GESIM1_raiz 
...
if (isset($_REQUEST['btn-visualizar'])) {
    echo "<script language=javascript>
    location.href='periodos_processados.php';
    </script>";
}

// if (isset($_REQUEST['btn-recusados'])) {
//     echo "<script language=javascript>
//     location.href='beneficios_recusados.php';
//     </script>";
// }

if (isset($_REQUEST['btn-enviados'])) {
    echo "<script language=javascript>
    location.href='beneficios_enviados.php';
    </script>";
}
...
if (isset($_REQUEST['btn-processar'])) {
    try {
        ...
        location.href='aceite_beneficios.php';
        </script>";
                } else {
                }
            } catch (PDOException $erro) {
        ...
        location.href='tabela_recibo_pagamento.php';
            ...
            try {
                ...
                if (0 == 0) {
                    ...
                    $tabela = 'public."GESIM1_' . $raiz_cnpj . '"';
                    $situac = 0;  //voltar situac para zero
                    ...
                    echo "<script language=javascript>
        alert('Registro(s) recusado(s) com sucesso!');
        location.href='tabela_recibo_pagamento.php';
        </script>";
                } else {
                }
