...
if (!empty($_SESSION["id_doc_documentacao"])) {
    unset($_SESSION["id_doc_documentacao"]);
}
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body p-1">
                        <div class="col-sm-12 text-right p-3">
                            <a href="index"><button type="button" name="btn-voltar" data-toggle="tooltip" title="Voltar home" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-undo-alt"></i> Voltar</button></a>
                        </div>
                            ...
                            <div class="row" id="accordion">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        foreach (selectVW_GESDOC_PAI() as $pai_informacoes) {
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row no-gutters align-items-center p-1">
                                                            <div class="col mr-2">
                                                                ...
                                                                foreach (selectVW_GESDOC_FILHO($grupo_pai) as $filho_informacoes) {
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <ul class="ul-padding-left-n">
                                                                        <li class="filho list-unstyled">

                                                                            <div id="heading<?php echo $collapse_neto; ?>">
                                                                                <h5 class="mb-0">
                                                                                    <button class="btn btn-transparent text-gray-800" data-toggle="collapse" data-target="#collapse<?php echo $collapse_neto; ?>" aria-expanded="true" aria-controls="collapse<?php echo $collapse_neto; ?>">
                                                                            ...
                                                                            <ul id="collapse<?php echo $collapse_neto; ?>" class="collapse ul-padding-left-n" aria-labelledby="heading<?php echo $collapse_neto; ?>" data-parent="#accordion">

                                                                                <?php

                                                                                // FOREACH PARA LISTAR AS INFORMAÇÕES DO NETO
                                                                                foreach (selectVW_GESDOC_NETO($grupo_filho) as $neto_informacoes) {
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <ul class="mb-0 ul-padding-left-n">
                                                                        <li class="filho list-unstyled">
                                                                            ...
                                                                            <!-- UL PARA LISTAR OS ITENS NETO -->
                                                                            <ul id="collapse_base<?php echo $collapse_neto; ?>" class="collapse ul-padding-left-n" aria-labelledby="heading_base<?php echo $collapse_neto; ?>" data-parent="#accordion">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.direcionamento', function() {
            ...
            if (link !== '') {
                ...
                $.post('documentacao.php', dados, function(retorna) {
