...
<head>
    ...
    <title>GESTOU PORTAL - Importar Colaboradores</title>
    ...
    <script src="vendor/kartik-v/bootstrap-fileinput/js/fileinputxlsx.min.js"></script>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Importar Colaboradores</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <div class="row mt-sm-2">
                                            ...
                                            <input id="input-b1" name="input-b1" type="file" class="file" data-browse-on-zone-click="true" accept=".xls,.xlsx" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="textalign-right">
                                        ...
                                        <button type="button" name="btn-voltar" data-toggle="tooltip" title="Voltar importação" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-undo-alt"></i> Voltar</button>
                                    </div>
                                </div>
                            </div>
            ...
            <script src="scripts/importar_colaboradores.js?version=<? echo time(); ?>"></script>
