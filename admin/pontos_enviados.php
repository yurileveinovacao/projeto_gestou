                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                     ...
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Pontos Enviados</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered sortable" width="100%" cellspacing="0">
                                        <thead>
                                            ...
                                            <button type="submit" name="btn-voltar" data-toggle="tooltip" title="Voltar para Espelho de Ponto" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-undo-alt"></i> Voltar</button>
                                        ...
                                        <tbody class="texto-table-body">
                                            <?php foreach (selectESPELHO_PONTO($raiz_cnpj, 2) as $linha) { // Passar o parâmetro 1 para filtrar o status do GESIM1_raiz
                    if ($linha == 0) {
                    } else {
                        ?>
                                                    <tr>
