                                ...
                                <table id="dataTable" class="table table-bordered sortable" width="100%" cellspacing="0">
                                    <thead>
                                        <div class="col-sm-12 button-tabela">
                                            <button type="button" id="btn-voltar" data-toggle="tooltip" title="Voltar para os lotes" class="btn btn-organograma"><i class="fas fa-undo-alt"></i> Voltar</button>
                                        </div>
                                        <tr>
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="content-xy-center">
                                                        ...
                                                        <div class="div-acoes">
                                                            ...
                                                            <button type="button" onclick="sem_acao();" class="btn btn-primary" title="Sem ação">
