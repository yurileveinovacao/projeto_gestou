                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            $id_fun = $_SESSION["colaborador_editar"];
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                            <div class="textalign-right">
                                                <button type="button" id="btn-troca-senha" data-toggle="modal" data-target="#TrocarSenha" name="modal" class="btn btn-organograma btn-icon-split-organograma"><i class="fas fa-unlock mr-sm-2"></i> Trocar Senha</button>
        ...
        $(document).on('click', '#btn-removerfoto', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.post('controller/tabela_colaboradores_post.php', dados_form, function(retorno) {
