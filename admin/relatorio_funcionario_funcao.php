...
<body>
    ...
    <div class="content">
        ...
        <table>
            ...
            foreach (select_VW_REL_FUNCIONARIO_DADOS_FUNCIONARIO_FUNCAO($id_emp_default, $situac_filtro) as $funcao) :
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><?= $funcao["nome"]; ?></td>
                        <td><?= Mask("###.###.###-##", $funcao["cpf"]); ?></td>
                        <td><?= $funcao["funcao"]; ?></td>
                        <td><?= $funcao["departamento"]; ?></td>
                        <td><?= $funcao["situac_funcionario"]; ?></td>
