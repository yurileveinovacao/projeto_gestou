    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex">
                        ...
                        <small class="text-muted ml-auto">Atualizado em <?php $data = new DateTime($datatu);
                    ...
                    <div class="card-deck" style="height: 70vh;">
                        <div class="card" style="overflow: hidden; position: relative; max-height: 70vh;">
                            ...
                            <div style="height: 65%; padding: 16px 16px 16px 16px; display: flex; justify-content: center; align-items: center;">
                                <?php if (!empty($caminho_banco_modal)) { ?>
                                    <img class="card-img-top abrir-img" src="../upload/empresa/<?php echo $caminho_banco_modal; ?>" alt="Sobre Nós" style="max-height: 100%; max-width: auto; object-fit: contain;">
                                <?php } else { ?>
                                    <img class="card-img-top" src="../upload/empresa/sobre_nos_default.png" alt="Sobre Nós" style="max-height: 70%; max-width: auto; object-fit: contain; opacity: 0.2;">
                                <?php } ?>
                            </div>

                            <div class="card-body mt-2" style="height: 35%; padding: 0 25% 0 25%;">
                                <div style="overflow-y: auto; scrollbar-width: thin; height: 100%;">
                                    <?php echo $texto_banco_modal; ?>
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                <div class="div-acoes" style="text-align: right">
                                    <div class="div-acoes" style="text-align: right">
                                        <button type="button" class="btn btn-primary visualizar-imagem" title="Imagem">
                                            <i class="fas fa-file-image"></i>
                                        </button>

                                        <button type="button" class="btn btn-primary visualizar-texto" title="Texto">
            ...
            <div class="modal-dialog" style="max-width: 50%; margin: 0 auto; display: flex; align-items: center; justify-content: center; height: 100vh;">
                <div class="modal-content" style="overflow-y: auto; width: 100%;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-title-img">Sobre Nós</h5>
        ...
        <div id="modal-texto" class="modal fade" tabindex="-1" aria-labelledby="modal-texto" aria-hidden="true">
            <div class="modal-dialog" style="max-width: 50%; margin: 0 auto; display: flex; align-items: center; justify-content: center; height: 100vh;">
                <div class="modal-content" style="overflow-y: auto; width: 100%;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-title-texto">Sobre Nós</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id='form-text'>
    ...
    $(function() {
        $(document).on('click', '.visualizar-imagem', function() {
            ...
            if (visualizar_img !== '') {
                ...
                $.post('controller/sobre_nos_post.php', dados, function(retorno) {
                    ...
                    success: function(retorno) {
                        ...
                        switch (retorno) {
                            ...
                            case '0':
                                ...
                                // Se o retorno for igual a 1, Imagem atualizada com sucesso
                            case '1':
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Sucesso!',
                    ...
                    if (btn_exc_img !== '') {
                        ...
                        $.post('controller/sobre_nos_post.php', dados, function(retorno) {
                            ...
                            switch (retorno) {
                                ...
                                // Se o retorno for igual a 1, Imagem Excluida
                                case '1':
                                    Swal.fire({
                                        icon: 'success',
                                        title: 'Sucesso!',
