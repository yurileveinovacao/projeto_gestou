 ...
 * Filtros 
 */
if ((isset($_POST['btn_filtrar'])) and (isset($_POST['colaborador_filtro_situac']))) {
    ...
    switch ($campo) {
        ...
        case "VALOR_DECIMAL";
            ...
            if (!empty($valor)) {
                ...
                $valorSemMoeda = str_replace("R$ ", "", $valor); // remove o símbolo de moeda
                $valorSemMoeda = str_replace(".", "", $valorSemMoeda); // remove o ponto separador de milhar
