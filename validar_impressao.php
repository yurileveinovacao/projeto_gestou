...
<body>
    ...
    $id_validador = $_SESSION["download_id_validador"];
    $raiz_cnpj = $_SESSION["download_raiz_validador"];
            ...
            <div class="page" style="font-size: 9pt">
                ...
                <table class="width-100" style="border-top: 1px solid black; padding-top: 0.5em; margin-top: 0.5em;">
                    <tr>
                        <td>CÓDIGO DE VALIDAÇÃO:</td>
                        <td> &nbsp; </td>
                        <td class="text-right"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?php include "validar_gera_qrcode_holerite.php" ?></td>
                    </tr>
                    <tr>
