...
if (isset($_SESSION["id_validador_recibo"])) {

    unset($_SESSION["id_validador_recibo"]);
}

if (isset($_SESSION["id_validador_holerite"])) {
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="iconedireita user-select-none">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active h4" aria-current="page">Holerite</li>
                        </ol>
                    </div>
                                    ...
                                    <?php if ($situac == 2) { ?>
                                        ...
                                        <div class="col-xl-3 col-md-6 mb-4 recibo pendente">
                                            <div class="card h-100">
                                                <a href="holerite_item?vw=<?php echo $id_validador ?>" class="tag-a-sem-acao">
                                                    <div class="card-body">
