...
<head>
    ...
    <title>Gestou - Itens Informe de Rendimento</title>
                ...
                ?>
                        ...
                        <div class="container-fluid" id="container-wrapper">
                            ...
                            <div class="iconedireita mb-1 user-select-none">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item h4"><a href="informe_rendimento"><i class="fas fa-chevron-circle-left fa-1x"></i></a></li>
                                    <li class="breadcrumb-item active h4" aria-current="page">Itens Informe de Rendimento</li>
                                </ol>
