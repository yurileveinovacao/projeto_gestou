...
unset($_SESSION["id_validador_holerite"]);
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="iconedireita user-select-none">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item h4"><a href="documentos"><i class="fas fa-chevron-circle-left fa-1x"></i></a></li>
                            <li class="breadcrumb-item active h4" aria-current="page">Recibos Pagamentos </li>
                        </ol>
                    </div>
                    ...
                    <div class="row mb-3 recibos">
                        ...
                        foreach (select_GESIM1($raiz_cnpj, $id_emp_default, $id_usu_default) as $recibo_pagamento) {

                            $id_validador = $recibo_pagamento['id_validador'];
                            $descricao = $recibo_pagamento['descricao'];
                            $competencia = $recibo_pagamento['competencia'];
                            $vlr_liquido = $recibo_pagamento['vlr_liquido'];
                            $situac = $recibo_pagamento['situac'];

                            if (($vlr_liquido == "0.00") or ($vlr_liquido == "") or ($vlr_liquido == " ")) {

                                $vlr_liquido = NULL;
                            }


                            if ($recibo_pagamento != 0) {

                                if ((empty($descricao)) or (empty($vlr_liquido))) {
                        ...
                        ?>
                                    ...
                                    <?php if ($situac == 2) { ?>
                                        ...
                                        <div class="col-xl-3 col-md-6 mb-4 recibo pendente">
                                            <div class="card h-100">
                                                <a href="recibo_item?vw=<?php echo $id_validador ?>" class="tag-a-sem-acao">
                                                    <div class="card-body">
                                                        <div class="row align-items-center text-align-center" style="text-align: center;">
                                                            <div class="col mr-2">
                                                                <div class="h6 mb-0 font-weight-bold text-gray-800 mb-4">RECIBO DE
                                                                    PAGAMENTO
                                                                </div>
                                    ...
                                    ?>
                                        ...
                                        <!-- RECIBOS -->
                                        <div class="col-xl-3 col-md-6 mb-4 recibo reprovado" style="display: none;">
                                            <div class="card h-100">
                                                <a href="recibo_item?vw=<?php echo $id_validador ?>" class="tag-a-sem-acao">
                                                    <div class="card-body">
                                                        <div class="row align-items-center text-align-center" style="text-align: center;">
                                            ...
                                            <div class="card h-100">
                                                <a href="recibo_item?vw=<?php echo $id_validador ?>" class="tag-a-sem-acao">
                                                    <div class="card-body">
                                                        <div class="row align-items-center text-align-center" style="text-align: center;">
                                                            <div class="col mr-2">
                                                                <div class="h6 mb-0 font-weight-bold text-gray-800 mb-1">RECIBO DE
                                                                    PAGAMENTO
                                                                </div>
                                                                <div class="text-xs font-weight-bold text-uppercase">
                                                                    <?php echo $descricao ?></div>
                                                                <div class="text-xs font-weight-bold text-uppercase">
                                                                    <?php echo $competencia ?></div>
                                                                <div class="text-xm font-weight-bold text-uppercase mb-1"><span class="text-warning mr-2">
                                                                        Líquido: R$ <?php echo $vlr_liquido ?></div>
                                                                <div class="text-xm font-weight-bold text-uppercase mb-1">
                                                                    <div class="btn btn-warning btn-icon-split">
                                                                        <span class="icon text-white-50">
                                                                            <i class="fas fa-exclamation-triangle"></i> </span>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row align-items-center text-align-center" style="text-align: center;">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="text-xs font-weight-bold text-uppercase">
                                                                    <?php echo $descricao ?></div>
                                                                <div class="text-xs font-weight-bold text-uppercase"><?php echo $competencia ?></div>
                                                                <div class="text-xm font-weight-bold text-uppercase mb-1"><span class="text-success mr-2">
                                                                        Líquido: <?php echo $vlr_liquido ?></div>
                                                                <div class="text-xm font-weight-bold text-uppercase mb-1">
                                                                    <div class="btn btn-success btn-icon-split">
                                                                        <span class="icon text-white-50">
                                                                            <i class="fas fa-check"></i>
                                                        ...
                                                        <div class="row align-items-center text-align-center" style="text-align: center;">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="text-xs font-weight-bold text-uppercase">
                                                                    <?php echo $descricao ?></div>
                                                                <div class="text-xs font-weight-bold text-uppercase"><?php echo $competencia ?></div>
                                                                <div class="text-xm font-weight-bold text-uppercase mb-1"><span class="text-danger mr-2">
                                                                        Líquido: <?php echo $vlr_liquido ?></div>
                                                                <div class="text-xm font-weight-bold text-uppercase mb-1">
                                                                    <div class="btn btn-danger btn-icon-split">
                                                                        <span class="icon text-white-50">
                                ...
                                <!-- IMAGEM CASO NÃO HAJA REGISTROS -->
                                <div class="m-auto">
                                    <img class="img-fluid" width="400" src="img/logo/blank_recibo.png"></img>
                                </div>
