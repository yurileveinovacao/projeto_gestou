...
<head>
    ...
    <title>Gestou - Itens Políticas</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                if (isset($_SESSION['id_pol_item'])) {
                    ...
                    $id_pol = $_SESSION["id_pol_item"];
                } else {

                    // Caso contrário, exibe uma mensagem de aviso usando o plugin Swal.fire e redireciona para 'empresa_politica_codconduta'
                    echo "
                        <script>
                        Swal.fire({
                        icon: 'info',
                        title: 'Info',
                        title: 'Atenção!',
                        text: 'Nenhuma politica selecionada!'
                        }).then((result) => {
                        location.href='empresa_politica_codconduta';
                        });
                        </script>
                    ";
                }
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="iconedireita mb-1 user-select-none">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active h4" aria-current="page">Itens Políticas</li>
                        </ol>
                    ...
                    <div class="row mb-1">
                        ...
                        foreach (selectGESPOL_item($id_pol) as $linha) {
                        ...
                        ?>
                            ...
                            <div class="card shadow mb-2 width-100">
                                <div class="d-block card-header py-3 collapsed">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <!-- Este link faz o download de um arquivo com base em variáveis PHP. -->
                                            <a href="../upload/empresa/politicas/<?php echo $anexo; ?>" download="<?php echo $anexo_nome; ?>" class="width-100">
                                                <!-- Este botão representa o botão de download. -->
    ...
    <!-- Esses são os scripts utilizados no código: -->

    <!-- Este script carrega a biblioteca jQuery da versão 3.3.1 a partir do servidor do Google. -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>

    <!-- Este script carrega a biblioteca jQuery minificada a partir de um diretório local. -->
    <script src="vendor/jquery/jquery.min.js"></script>

    <!-- Este script carrega a biblioteca Bootstrap minificada a partir de um diretório local. -->
    <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Este script carrega a biblioteca jQuery Easing minificada a partir de um diretório local. -->
    <script src="vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Este script carrega o arquivo "ruang-admin.min.js" a partir de um diretório local. -->
...
<script>
    ...
    $(function() {
        ...
        $(document).on('click', '.btn-voltar', function() {
            ...
            // Redireciona para a página 'empresa_politica_codconduta'
            location.href = 'empresa_politica_codconduta';
        });
    });
