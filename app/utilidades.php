            ...
            <ol class="breadcrumb iconedireita">
              ...
              <li class="breadcrumb-item active" aria-current="page">Dashboard</li>
                    ...
                    <div class="iconedireita mb-4 user-select-none">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item h4"><a href="index"><i class="fas fa-chevron-circle-left fa-1x"></i></a></li>
                            <!-- <li class="breadcrumb-item">Bootstrap UI</li> -->
                            <li class="breadcrumb-item active h4" aria-current="page">Utilidades</li>
                        </ol>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <a class="text-decoration-none" href="treinamentos_manuais">
                                    <div class="card-body user-select-none">
                                        <div class="row align-items-center padding-2em">
                                            <div class="col mr-2">
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">Treinamentos / Manuais
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <img src="img/logo/treinamentos_manuais.svg" height="32" width="24"></img>
                                            </div>
                                        </div>
                                    </div>
                                </a>
