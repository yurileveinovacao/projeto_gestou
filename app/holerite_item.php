                    ...
                    if (isset($_REQUEST['vw'])) {
                        ...
                        <div class="container-fluid" id="container-wrapper">
                            ...
                            <div class="iconedireita mb-1 user-select-none">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item h4"><a href="holerite"><i class="fas fa-chevron-circle-left fa-1x"></i></a></li>
                                    <li class="breadcrumb-item active h4" aria-current="page">Itens Holerite</li>
                                </ol>
                                    ...
                                    <div class="card shadow mb-2 width-100">
                                        ...
                                        <div class="d-block card-header py-3 collapsed">
                                            ...
                                            ?>
                                                ...
                                                <form action="holerite_item.php" method="POST">
                                                ...
                                                <div class="collapse show" id="reprovar">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="width-100" action="holerite_item.php" method="POST">
...
try {
    ...
    if (isset($_REQUEST['btn-aprovar'])) {
        ...
        echo "<script language=javascript>
			...
			location.href = 'holerite_item?vw=" . $_SESSION['id_validador_recibo'] . "';
			</script>";
    }
} catch (PDOException $erro) {
    echo $erro->getMessage();
