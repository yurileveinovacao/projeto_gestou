...
if (isset($_SESSION["id_irr_imposto"])) {
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="iconedireita user-select-none">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active h4" aria-current="page">Informe de Rendimento</li>
                        </ol>
                    </div>
                                ...
                                <?php if ($situac_visualizar == 0) { ?>
                                    ...
                                    <div class="col-xl-3 col-md-6 mb-4 recibo pendente">
                                        <div class="card h-100">
                                            <a href="informe_item?vw=<?php echo $id_irr ?>" class="tag-a-sem-acao">
                                                <div class="card-body">
