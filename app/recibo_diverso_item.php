                ...
                ?>
                        ...
                        <div class="container-fluid" id="container-wrapper">
                            ...
                            <div class="iconedireita mb-1 user-select-none">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item h4"><a href="recibo_diverso"><i class="fas fa-chevron-circle-left fa-1x"></i></a></li>
                                    <li class="breadcrumb-item active h4" aria-current="page">Item Recibo Diversos</li>
                                </ol>
                                    ...
                                    <div class="card shadow mb-2 width-100">
                                        ...
                                        <div class="d-block card-header py-3 collapsed">
                                            ...
                                            ?>
                                                ...
                                                <form action="recibo_diverso_item" method="POST">
                                                ...
                                                <div class="collapse show" id="reprovar">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <form class="width-100" action="recibo_diverso_item" method="POST">
...
try {
    ...
    if (isset($_REQUEST['btn-aprovar'])) {
        ...
        echo "<script language=javascript>
			...
			location.href = 'recibo_diverso_item?vw=" . $_SESSION['id_validador_recibo'] . "';
			</script>";
    }
} catch (PDOException $erro) {
    echo $erro->getMessage();
