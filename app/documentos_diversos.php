...
if (isset($_SESSION["id_rec_recibo"])) {
...
<head>
    ...
    <title>Gestou - Documentos Diversos</title>
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="iconedireita user-select-none">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active h4" aria-current="page">Documentos Diversos</li>
                        </ol>
                    </div>
                                ...
                                <?php if ($situac == 2) { ?>
                                    ...
                                    <div class="col-xl-3 col-md-6 mb-4 recibo pendente">
                                        <div class="card h-100">
                                            <a href="documentos_diversos_item?vw=<?php echo $id_validador ?>" class="tag-a-sem-acao">
                                                <div class="card-body">
