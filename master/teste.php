                                            ...
                                            ?>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="RG" attrname="RG" name="RG" maxlength="15" value="<?php echo $linha["rg"] ?>">
                                                            <div class="invalid-feedback">
                                                                Inválido!
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="email" name="email" value="<?php echo $linha["email"] ?>" pattern="(?![_.-])((?![_.-][_.-])[\w.-]){0,63}[a-zA-Z._\d]@((?!-)((?!--)[a-zA-Z\d-]){0,63}[a-zA-Z\d]\.){1,2}([a-zA-Z]{2,14}\.)?[a-zA-Z]{2,14}">
                                                            <div class="invalid-feedback">
                                                                Inválido!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="celular" attrname="celular" name="celular" pattern="\([0-9]{3}\)[\s][0-9]{5}-[0-9]{4}" minlength="15" value="<?php echo $linha["celular"] ?>">
                                                            <div class="invalid-feedback">
                                                                Inválido!
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="menu-endereco" role="tabpanel" aria-labelledby="menu-endereco-tab">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" id="CEP" attrname="cep" name="cep" value="<?php echo $linha["cep"] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="menu-informacoes" role="tabpanel" aria-labelledby="menu-informacoes-tab">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="pis" name="pis" maxlength="15" value="<?php echo $linha["pis"] ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="ctps">CTPS</label>
                                                    <input type="text" class="form-control" id="ctps" name="ctps" maxlength="15" value="<?php echo $linha["ctps"] ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="cbo">CBO</label>
                                                    <input type="text" class="form-control" id="cbo" name="cbo" maxlength="15" value="<?php echo $linha["cbo"] ?>">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="tiposalario">Tipo Salário</label>
                                                    <select class="form-control" name="tiposalario" id="tiposalario" required>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="salario" placeholder="R$" name="salario" onKeyPress="return(moeda(this,'.',',',event))" value="R$ <?php echo $salario_vw = str_replace('.', ',', $linha["salario"]); ?>">
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="dependentes">Dependentes</label>
                                                    <input type="number" step="1" min="0" max="10" class="form-control" id="dependentes" name="dependentes" maxlength="2" pattern="[0-9]{1,2}" value="<?php echo $linha["dependentes"] ?>">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="funcao">Função</label>
                                                    <input type="text" class="form-control" id="funcao" style="text-transform:uppercase" name="funcao" maxlength="25" value="<?php echo $linha["funcao"] ?>">
                                                </div>
                                                <div class="col-md-2 mb-3">
...
if (isset($_REQUEST["btn-submit"])) {
    ...
    try {
        ...
        $dataadmis_update = new DateTime($dataadmis_update);
        $dataadmis_update = $dataadmis_update->format("Y-m-d");

        $datanasc_update = new DateTime($datanasc_update);
        $datanasc_update = $datanasc_update->format("Y-m-d");
        ...
        updateGESUSU_alterar_funcionario($nome, $cpf_update, $rg_update, $celular_update, $email_update, $telefone_update, $id_mun, $dataadmis_update, $datanasc_update, $ctps_update, $pis_update, $cbo_update, $datarescisao_update, $funcao_update, $tiposalario_update, $endereco, $complemento_update, $bairro, $dependentes_update, $salario_update, $numero_update, $departamento_form, $gestor_form, $sexo, $escolaridade_update, $cep_update, $id_emp_default, $id_fun, $datatu, $id_usa_default);
