            ...
            <div class="error-502">
                <div class="error-502__text">
                    <div class="row justify-content-center">
                        <h1>Foi encontrado um erro <b>:(</b></h1>
                    </div>
                    <div class="row justify-content-center">
                        <p>Favor entrar em contato com o suporte.</p>
                    </div>
                    <div class="row justify-content-center" style="padding: 0 20em;">
                        <div class="col-md-1">
                        </div>
                        <div class="col-md-10">
                            <textarea id="erro" style="user-select: none; width: 100%; resize: none; text-align: center; outline: 0;border:none;color: #7f8084;line-height: 1.429;margin-top: 0;font-weight: 300;font-size: 1.5rem;" readonly><?php echo $_SESSION["erro_importação"]; ?></textarea>
                        </div>
