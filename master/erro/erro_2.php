...
<body>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Foi encontrado um erro</title>
        ...
        <div class="error-502__container">
            <div class="error-502">
                <div class="error-502__text">
                    ...
                    <h2>
                        <p>O formato do arquivo selecionado está incorreto.</p> <a href="../recibo_pagamento.php"><button class="btn btn-brave" style="margin-bottom: 50px;">VOLTAR</button></a>
                    </h2>
                </div>
            </div>
        </div>
