...
$sql = 'SELECT nome,id_usa from public."GESMAS" where id_mas='.$id_mas.'';
$res = pg_exec($conn, $sql);
$linha = pg_fetch_assoc($res);

$_SESSION["id_usa"] = $linha['id_usa'];
...
// $imagem = $linha['imagem']; ?>
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span
                class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $linha['nome']; ?></span>

                <img class="img-profile rounded-circle" src="../img/logo_gestou_fundo_amarelo.png">
